...
| <a name="input_alb_internal"></a> [alb\_internal](#input\_alb\_internal) | Whether the load balancer is internal or external. Defaults to false. | `bool` | `false` | no |
...
| <a name="input_rds_allocated_storage"></a> [rds\_allocated\_storage](#input\_rds\_allocated\_storage) | Instance allocated storage for RDS. Defaults to `20` | `number` | `20` | no |
